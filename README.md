...
- [ ] Show single image prediction with correct result
- [ ] Show bulk upload flow
- [ ] Show retraining trigger + status polling
- [ ] Show the live Railway URL in the browser

## Deployment Notes

- Frontend and backend are currently deployed as separate services.
...
- Backend can use persistent disk paths:

```env
UPLOAD_DATA_DIR=/var/data/uploads
RETRAIN_DATA_DIR=/var/data/retrain
```
